...
import 'package:flutter_spiks_test/widgets/gap/rendering/gap.dart';
...
class _RawGap extends LeafRenderObjectWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(
          DoubleProperty('mainAxisExtent', mainAxisExtent),
      )
      ..add(
    ...
    ..add(
        EnumProperty<Axis>('fallbackDirection', fallbackDirection),
    );
  }
}

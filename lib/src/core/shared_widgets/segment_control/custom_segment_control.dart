...
//
// const Duration _kHighlightAnimationDuration = Duration(milliseconds: 400);
...
class CustomSlidingSegmentedControl<T> extends StatefulWidget {
  ...
  /// Text style of not selected segment text
  final TextStyle textStyle;

  /// Text style of selected segment text
  final TextStyle selectedTextStyle;

  /// Border radius of CustomSlidingSegmentControl indicator
  final double indicatorRadius;

  /// Border radius of CustomSlidingSegmentControl
  final double radius;

  /// Duration of an animation
  final Duration duration;

  /// alignment of text inside segments
  final Alignment alignment;
...
class _SegmentedControlState<T> extends State<CustomSlidingSegmentedControl<T>>
  ...
  void onHighlightChangedByGesture(T newValue) {
    ...
    // TO DO(LongCatIsLooong): https://github.com/flutter/flutter/issues/74356:

...
import 'package:flutter_spiks_test//src/core/shared_widgets/widgets/custom_circular_progress.dart';
import 'package:flutter_spiks_test//src/core/shared_widgets/widgets/try_again_widget.dart';
        ...
        itemBuilder: (context, index) {
          if (index >= itemCount) {
            ...
            if (paginationStatus == PaginationStatus.error) {
              return TryAgainListing(onTryAgain: paginationCallback);
            }
